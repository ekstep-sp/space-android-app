...
//                    }
                    ...
                    encryptDecyptService.putExtra(Constants.typeOfEncrptDecrypt,"EncryptData");
                    encryptDecyptService.putExtra(Constants.encryptDecryptDownloadId, downloadId);
...
//                    Log.d("DownloadStatusBroadcast","Download Failed");
                    ...
                    try {
                        AppDatabase.getDb(context).downloadStatusDao().updateDownloadStatus(downloadId, 0, Constants.FAILED);
                    } catch (Exception e) {
